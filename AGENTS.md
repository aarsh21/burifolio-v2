...
- **Language**: TypeScript
- **Package Manager**: bun
- **Add-ons**: prettier, eslint, tailwindcss, mdsvex, devtools-json, mcp
...
btca ask -r sveltekit -q "How do I create a server function?"

# Ask about multiple resources
btca ask -r svelte -r sveltekit -q "Best practices for data loading?"
